  ...
  <div className={classes.box}>
    ...
    <div className={classes.dropdown}>
      ...
      >
        ...
        <NavDropdown.Item eventKey="Missing">Missing</NavDropdown.Item>
        <NavDropdown.Item eventKey="Crown">Crown</NavDropdown.Item>
        <NavDropdown.Item eventKey="Implant">Implant</NavDropdown.Item>
        <NavDropdown.Item eventKey="Brigde">Bridge</NavDropdown.Item>
      </NavDropdown>
      {information.implant && (
          <img className={classes.implant} src={implant} height={37} width={37}/>
      )}
    </div>
